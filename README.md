...
Pilot area: BS22/BS23/BS24 (Weston-super-Mare), see `config/areas.yaml`.
...
1. **Ingestion** — deduped business list for BS22/BS23/BS24 from three sources:
   - `npm run companies:fetch` — Companies House (registered office in BS22/BS23/BS24)
